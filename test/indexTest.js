const Formatter = require('./path_to_formatter'); // Make sure to adjust the path as necessary

describe("Formatter", () => {
  describe("capitalize", () => {
    it("is a static method", () => {
      expect(Formatter.capitalize("crocodile")).to.exist; // Check if the method exists
    });
  ...
  describe("sanitize", () => {
    it("is a static method", () => {
      expect(Formatter.sanitize("C catching colds")).to.exist; // Check if the method exists
    });
  ...
  describe("titleize", () => {
    it("is a static method", () => {
      expect(Formatter.titleize("F forever foolish")).to.exist; // Check if the method exists
    });
